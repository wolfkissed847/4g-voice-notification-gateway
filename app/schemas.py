...
#
# ── ทำไมลดจาก 500 เหลือ 120 (22 ก.ย. 2569) ────────────────────────────────
...
#
# วัดจริงกับข้อความภาษาไทยที่บีบ 8kbps แล้ว (บิตเรตต่ำสุดที่ระบบยอมถอยลงไป):
#     90 ตัวอักษร  -> 16,632 ไบต์   เหลือที่ว่าง 3,848
#    110 ตัวอักษร  -> 20,232 ไบต์   เหลือที่ว่าง   248  ← เฉียดมาก
#    120 ตัวอักษร  -> 22,104 ไบต์   เกินเพดาน
#
# ⚠️ ตัวเลขนี้วัดจาก "ข้อความหนาแน่น" (คำสั้นๆ เยอะ = จุลภาคเยอะ = ช่วงเงียบเยอะ)
# ซึ่งกินพื้นที่มากกว่าข้อความปกติที่ยาวเท่ากันเกือบ 40% — ข้อความปกติ 150 ตัวอักษร
# ได้ 20,016 ไบต์ แต่ข้อความหนาแน่น 150 ตัวอักษรได้ 27,504 ไบต์
# จำนวนตัวอักษรจึงทำนายขนาดไฟล์ไม่ได้แม่น ต้องมีด่านที่วัดขนาดไฟล์จริงด้วย
# (ดู _MODULE_MAX_BYTES ใน tts_service.py ที่ไล่ลดบิตเรตแล้วเตือนถ้ายังเกิน)
