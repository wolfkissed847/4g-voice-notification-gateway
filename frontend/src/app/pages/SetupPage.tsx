...
export function SetupPage() {
  ...
  return (
    /* gap-3.5 ให้ตรงกับหน้าคิว/ประวัติ — เดิมเป็น gap-4 อยู่หน้าเดียว
       ...
       - แท็บอุปกรณ์เคยเป็นกริดการ์ดที่ยาวเกินจอได้ จึงเคยใช้ min-h-full
         ตอนนี้รื้อเป็นรายการซ้าย + แผงตั้งค่าขวาที่เลื่อนอยู่ในตัวเองทั้งคู่แล้ว
         จึงต้องการความสูงที่แน่นอนเหมือนอีกสองแท็บ ไม่งั้นการ์ดจะยืดตามเนื้อหา
         แล้วดันทั้งหน้าให้เลื่อนแทนที่จะเลื่อนอยู่ในการ์ด */
    <div className={cn('flex h-full min-h-0 flex-col gap-3.5')}>
