 ...
 *
 * ที่ดีไซน์มีแต่เราไม่ได้ทำ เพราะ backend ไม่มี endpoint รองรับ: เครดิตซิม,
 * เสียงชาย-หญิง+ความเร็ว, เปลี่ยนรหัสผ่านจากหน้าเว็บ, ออกจากระบบทุกอุปกรณ์
 * — ไม่ได้ทำเป็นช่องหลอกไว้ และไม่ได้ขึ้นกล่องบอกบนหน้าเว็บด้วย (ถอดออกแล้ว):
 * มันเป็นข้อมูลของคนเขียนโค้ด ไม่ใช่ของคนใช้งาน คนที่เปิดหน้านี้มาดูอุณหภูมิ Pi
 * ไม่ได้ต้องการรู้ว่าดีไซน์เคยวาดอะไรไว้แล้วยังไม่ได้ทำ
 * ถ้าจะเพิ่มทีหลัง เริ่มที่ endpoint ก่อนเสมอ แล้วค่อยต่อหน้าเว็บ
 */
...
export function SystemPage() {
  ...
  return (
    /* lg ขึ้นไป: h-full = พอดีจอ ไม่ต้องเลื่อน — สามส่วนของหน้านี้ (ฮาร์ดแวร์ / ค่าการโทร /
       หมายเหตุ) เป็นข้อมูลที่ต้องดูพร้อมกันตอนไล่ปัญหา ถ้าต้องเลื่อนไปมาจะเทียบไม่ได้

       ต่ำกว่า lg: ปล่อยให้สูงตามเนื้อหาแล้วเลื่อนทั้งหน้าตามปกติ — บนมือถือการ์ดสามใบ
       เรียงซ้อนกันแนวตั้งอยู่แล้ว บังคับให้ทุกอย่างอยู่ในความสูงจอเดียวจึงเป็นไปไม่ได้
       ผลคือการ์ดค่าการโทรถูกบีบจนเหลือแถบเลื่อนแคบๆ อ่านอะไรไม่ได้เลย */
    <div className="flex flex-col gap-2.5 lg:h-full lg:min-h-0">
      ...
      {/* lg ขึ้นไป: min-h-0 + flex-1 = การ์ดค่าการโทรกินความสูงที่เหลือของจอ แล้วเลื่อน
          "ในตัวเอง" ถ้าเนื้อหาไม่พอดี — ไม่ปล่อยให้ทั้งหน้าเลื่อน ซึ่งจะดันการ์ดฮาร์ดแวร์
          ข้างบนหายไป ทั้งที่เป็นข้อมูลที่ต้องดูคู่กันตอนไล่ปัญหา

          ต่ำกว่า lg: ไม่จำกัดความสูงและไม่เลื่อนในตัวเอง ปล่อยให้การ์ดสูงตามเนื้อหา
          แล้วเลื่อนทั้งหน้าแทน — บนมือถือ max-h-full ทำให้การ์ดถูกบีบจนเหลือช่องแคบๆ
          ที่ต้องเลื่อนในกล่องเล็กๆ อีกที ซึ่งใช้งานไม่ได้จริง */}
      <div className="grid grid-cols-[repeat(auto-fit,minmax(min(320px,100%),1fr))] items-start gap-3.5 lg:min-h-0 lg:flex-1">
        <Card className="col-span-full flex flex-col gap-2.5 overscroll-contain p-3.5 lg:max-h-full lg:min-h-0 lg:overflow-y-auto">
